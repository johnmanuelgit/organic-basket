...
@Component({
  selector: 'app-ratna-alphonso',
  standalone:true,
  imports: [CommonModule, FormsModule, RouterModule, RouterLink],
  templateUrl: './ratna-alphonso.component.html',
  styleUrl: './ratna-alphonso.component.css'
})
export class RatnaAlphonsoComponent implements OnInit, OnDestroy {
  products: any[] = [];
  quantity = 1;
  price = 2499;
  currentStartIndex = 0;
