...
@Component({
  selector: 'app-kesar-mango',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule, RouterLink],
  templateUrl: './kesar-mango.component.html',
  styleUrl: './kesar-mango.component.css'
})
export class KesarMangoComponent implements OnInit, OnDestroy {
  products: any[] = [];
  quantity = 1;
  price = 2499;
  currentStartIndex = 0;
