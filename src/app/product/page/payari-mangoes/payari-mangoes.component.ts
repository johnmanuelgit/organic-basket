...
@Component({
  selector: 'app-payari-mangoes',
  standalone:true,
  imports: [CommonModule, FormsModule, RouterModule, RouterLink],
  templateUrl: './payari-mangoes.component.html',
  styleUrl: './payari-mangoes.component.css'
})
export class PayariMangoesComponent implements OnInit, OnDestroy {
  products: any[] = [];
  quantity = 1;
  price = 2299;
  currentStartIndex = 0;
  ...
  isOpenss:boolean=false
  toggleFAQ() {
    this.isOpens = !this.isOpens;
    
  }
  toggleFAQs() {
    this.isOpenss=!this.isOpenss
  }
}
